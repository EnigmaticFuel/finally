...
**Verification depth scales with `asvs_level`** (see @C:/Users/ehasi/OneDrive/Documents/AI Coder Course/Project/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
