...
- **Global scope**: `C:/Users/ehasi/OneDrive/Documents/AI Coder Course/Project/finally/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/ehasi/OneDrive/Documents/AI Coder Course/Project/finally/.claude/notes/`)
...
2. Glob `C:/Users/ehasi/OneDrive/Documents/AI Coder Course/Project/finally/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/ehasi/OneDrive/Documents/AI Coder Course/Project/finally/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/ehasi/OneDrive/Documents/AI Coder Course/Project/finally/.claude/notes/` — works in any directory
